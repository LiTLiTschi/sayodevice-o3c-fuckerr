...
#
# Layout verified via diag_light_v2.py before/after captures:
#   - Official app set GREEN (#00FF00): offset 0x14-0x16 = 00 FF 00
#   - Official app set BLUE  (#0000FF): offset 0x14-0x16 = 00 00 FF
#   - Mode (static=1) is at offset 0x00 as uint32_le
LIGHT_CONFIG_TEMPLATE = bytearray([
    0x01, 0x00, 0x00, 0x00, 0xB8, 0x0B, 0xB8, 0x0B,  # [0x00] mode(u32_le=1:static), fade_in(u16), fade_out(u16)
    0x08, 0x07, 0x08, 0x07, 0x64, 0x00, 0x00, 0x00,  # [0x08] ?,?,?,?, brightness(100), _,_,_
    0x00, 0x00, 0x64, 0x64, 0x01, 0x00, 0x00, 0x00,  # [0x10] _,_, speed1(100), speed2(100), R(1), G(0), B(0), _
...
# Offsets within light config data (verified via diag_light_v2.py)
LIGHT_MODE_OFFSET = 0x00       # uint32_le: 1=static
LIGHT_BRIGHTNESS_OFFSET = 0x0C # 0-100
LIGHT_SPEED1_OFFSET = 0x12
LIGHT_SPEED2_OFFSET = 0x13
LIGHT_R_OFFSET = 0x14           # Red   (0-255)
LIGHT_G_OFFSET = 0x15           # Green (0-255)
LIGHT_B_OFFSET = 0x16           # Blue  (0-255)


class LightMode:
    """Known light mode values (uint32 at offset 0x00)."""
    STATIC = 1
